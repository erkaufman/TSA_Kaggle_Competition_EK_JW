...
### Ensemble approach of averaging best performing model results with June Load data

```{r}
#load submission 2
Best_performing_model <- read_csv("output/Submission2_EK_JW.csv")
...
submission_ensemble_1 <- read_csv("output/submission_template.csv", 
    col_types = cols(load = col_number()))
